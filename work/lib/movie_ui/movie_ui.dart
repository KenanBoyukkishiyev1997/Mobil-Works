...
class MovieDetailsCast extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          MovieFiled(filed: "Cast", value: movie.actors),
          MovieFiled(filed: "Director", value: movie.director),
          MovieFiled(filed: "Awards", value: movie.awards),
        ],
      ),
    );
  }
...
class MovieFiled extends StatelessWidget {
  ...
  const MovieFiled({Key key, this.filed, this.value}) : super(key: key);
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: ListView.separated(scrollDirection: Axis.horizontal,  separatorBuilder: (context,index)=>SizedBox(width: 8,), itemCount: posters.length, itemBuilder: (context,index)=>ClipRRect(
